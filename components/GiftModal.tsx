      ...
      return (
        <div className="space-y-4">
          ...
          <FunQuiz
            ...
            icon="🌹"
            options={[
              { label: "Flowers", response: "Classic. Can't go wrong 🌹" },
              { label: "Chocolates", response: "Respect. Mood booster instantly 🍫" },
            ]}
    ...
    case 9:
      return (
        <div className="space-y-4">
          ...
          <p className="text-stone-600 leading-relaxed">
            If we weren&apos;t strangers, I&apos;d have sent you chocolates today. For now, imagine
            dark chocolate — calm, classy, and comforting.
          </p>
        ...
        <div className="space-y-4">
          ...
          <FunQuiz
            ...
            options={[
              ...
              { label: "Himalayas", response: "Okay explorer 👀 That's main-character energy." },
      ...
      return (
        <div className="space-y-5">
          ...
          <FunQuiz
            ...
            icon="💬"
            options={[
              { label: "Compliments", response: "Words matter. Fair." },
              { label: "Quality time", response: "Actions > words. Mature answer." },
            ]}
